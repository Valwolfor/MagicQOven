...
public class BigQueryController {
    ...
    public String executeQuery() throws InterruptedException {
        String sqlQuery = "SELECT dma_id, dma_name, term, week, score, rank, refresh_date FROM  `bigquery-public-data.google_trends.top_rising_terms` WHERE score IS NOT NULL LIMIT 10";
