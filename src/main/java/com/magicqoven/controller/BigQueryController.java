...
public class BigQueryController {
    ...
    @Autowired
    public BigQueryController(BigQueryFileGateway bigQueryFileGateway,
                              BigQueryTemplate bigQueryTemplate, BigQuery bigQuery, @Value("${spring.cloud.gcp.credentials.location}") String name, BigQueryServiceImpl service) {
